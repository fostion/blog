...
public class SpeedMainActivity extends Activity
{
	...
	class DownloadThread extends Thread
	{
		...
		{
			// TODO Auto-generated method stub
			String url_string="http://downali.game.uc.cn/s/0/8/201507301829420aecf2_000002_UC.apk?x-oss-process=udf/uc-apk,ESDDjEgTKBUX9777bceffa40631f";
			...
			try
			{
				...
				while(iStream.read()!=-1 && flag)
				{
					...
					if(cur_time-start_time==0)
					{
						...
						L.i("NetSpeedTask"," speed " + info.speed);
					}
				}
				iStream.close();
			} catch (Exception e)
